...
exports.config = Object.assign({
    ...
    exclude:[
        ...
        'test/functional/cart/*',
        'test/functional/checkout/guestUser/singleShip/*',
        'test/functional/compareProducts/*',
        'test/functional/home/*',
        'test/functional/misc/*',
        'test/functional/navigation/category/*',
        'test/functional/productDetails/*',
        'test/functional/quickview/*',
        'test/functional/search/*',
        'test/functional/MyFlow/NewFile.js',
